...
--
-- Host: localhost
-- Generation Time: Jul 25, 2022 at 03:05 PM
...
--
-- Database: `db_spekta_3`
--

-- --------------------------------------------------------

--
-- Table structure for table `tb_absensi_ekstra`
--
...
--
-- Dumping data for table `tb_absensi_ekstra`
--
...
--
-- Table structure for table `tb_auth_settings`
--
...
--
-- Dumping data for table `tb_auth_settings`
--
...
--
-- Table structure for table `tb_bina_ekstra`
--
...
--
-- Dumping data for table `tb_bina_ekstra`
--
...
--
-- Table structure for table `tb_cbt_time`
--
...
--
-- Dumping data for table `tb_cbt_time`
--
...
--
-- Dumping data for table `tb_data_sekolah`
--
...
--
-- Table structure for table `tb_kegiatan_ekstra`
--
...
--
-- Dumping data for table `tb_kegiatan_ekstra`
--
...
--
-- Table structure for table `tb_level_name`
--
...
--
-- Dumping data for table `tb_level_name`
--
...
--
-- Table structure for table `tb_sumber_uang`
--
...
--
-- Dumping data for table `tb_sumber_uang`
--
...
--
-- Table structure for table `tb_uang_keluar`
--
...
--
-- Dumping data for table `tb_uang_keluar`
--
...
--
-- Table structure for table `tb_uang_masuk`
--
...
--
-- Dumping data for table `tb_uang_masuk`
--
...
--
-- Table structure for table `tb_users_address`
--
...
--
-- Dumping data for table `tb_users_address`
--
...
--
-- Table structure for table `tb_users_cbt`
--
...
--
-- Dumping data for table `tb_users_cbt`
--
...
--
-- Table structure for table `tb_users_cbt_choice`
--
...
--
-- Dumping data for table `tb_users_cbt_choice`
--
...
--
-- Table structure for table `tb_users_cbt_date`
--
...
--
-- Dumping data for table `tb_users_cbt_date`
--
...
--
-- Table structure for table `tb_users_cbt_grade`
--
...
--
-- Dumping data for table `tb_users_cbt_grade`
--
...
--
-- Table structure for table `tb_users_cbt_status`
--
...
--
-- Dumping data for table `tb_users_cbt_status`
--
...
--
-- Table structure for table `tb_users_status`
--
...
--
-- Dumping data for table `tb_users_status`
--
...
--
-- Table structure for table `tb_users_utility`
--
...
--
-- Dumping data for table `tb_users_utility`
--
...
--
-- Table structure for table `tb_web_settings`
--
...
--
-- Dumping data for table `tb_web_settings`
--
...
--
-- Indexes for table `tb_absensi_ekstra`
--
...
--
-- Indexes for table `tb_auth_settings`
--
ALTER TABLE `tb_auth_settings`
  ADD PRIMARY KEY (`id_auth_setting`);

--
-- Indexes for table `tb_bina_ekstra`
--
...
--
-- Indexes for table `tb_kegiatan_ekstra`
--
...
--
-- Indexes for table `tb_level_name`
--
...
--
-- Indexes for table `tb_sumber_uang`
--
...
--
-- Indexes for table `tb_uang_keluar`
--
...
--
-- Indexes for table `tb_uang_masuk`
--
...
--
-- Indexes for table `tb_users_address`
--
...
--
-- Indexes for table `tb_users_cbt`
--
...
--
-- Indexes for table `tb_users_cbt_choice`
--
...
--
-- Indexes for table `tb_users_cbt_date`
--
...
--
-- Indexes for table `tb_users_cbt_grade`
--
...
--
-- Indexes for table `tb_users_cbt_status`
--
...
--
-- Indexes for table `tb_users_status`
--
...
--
-- Indexes for table `tb_users_utility`
--
...
--
-- Indexes for table `tb_web_settings`
--
...
--
-- AUTO_INCREMENT for table `tb_absensi_ekstra`
--
ALTER TABLE `tb_absensi_ekstra`
...
--
-- AUTO_INCREMENT for table `tb_kegiatan_ekstra`
--
ALTER TABLE `tb_kegiatan_ekstra`
...
--
-- AUTO_INCREMENT for table `tb_level_name`
--
ALTER TABLE `tb_level_name`
...
--
-- AUTO_INCREMENT for table `tb_sumber_uang`
--
ALTER TABLE `tb_sumber_uang`
...
--
-- AUTO_INCREMENT for table `tb_uang_keluar`
--
ALTER TABLE `tb_uang_keluar`
  MODIFY `id_pengeluaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `tb_uang_masuk`
--
ALTER TABLE `tb_uang_masuk`
...
--
-- Constraints for table `tb_absensi_ekstra`
--
ALTER TABLE `tb_absensi_ekstra`
...
--
-- Constraints for table `tb_bina_ekstra`
--
ALTER TABLE `tb_bina_ekstra`
...
--
-- Constraints for table `tb_uang_keluar`
--
ALTER TABLE `tb_uang_keluar`
...
--
-- Constraints for table `tb_uang_masuk`
--
ALTER TABLE `tb_uang_masuk`
...
--
-- Constraints for table `tb_useranswer`
--
ALTER TABLE `tb_useranswer`
...
--
-- Constraints for table `tb_users_address`
--
ALTER TABLE `tb_users_address`
...
--
-- Constraints for table `tb_users_cbt`
--
ALTER TABLE `tb_users_cbt`
...
--
-- Constraints for table `tb_users_cbt_choice`
--
ALTER TABLE `tb_users_cbt_choice`
...
--
-- Constraints for table `tb_users_cbt_date`
--
ALTER TABLE `tb_users_cbt_date`
...
--
-- Constraints for table `tb_users_cbt_grade`
--
ALTER TABLE `tb_users_cbt_grade`
...
--
-- Constraints for table `tb_users_cbt_status`
--
ALTER TABLE `tb_users_cbt_status`
...
--
-- Constraints for table `tb_users_status`
--
ALTER TABLE `tb_users_status`
...
--
-- Constraints for table `tb_users_utility`
--
ALTER TABLE `tb_users_utility`
