                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-danger btn-sm"
                                    href="<?php echo $url_config . 'del_moneyoutekstra.php?id_pengeluaran=' . $d['id_pengeluaran']; ?>">
                                    DELETE
                                </a>
                            </td>
                        </tr>
            ...
            <div class="card-body">
                ...
                <form class="form-sample needs-validation text-start" novalidate onSubmit="return validasi(this);"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary mr-2" name="uangkeluarekstra">Submit</button>
