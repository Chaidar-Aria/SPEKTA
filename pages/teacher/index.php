...
// NAMA EKSTRA
$sqlpembina = mysqli_query($conn, "SELECT * FROM tb_ekstrakurikuler 
...
while ($data = mysqli_fetch_array($sqlpembina)) {
    ...
    //HITUNG ADMIN
    $hitungadmin = mysqli_query($conn, "SELECT * FROM tb_admin WHERE id_ekstra='$idekstra'");
    $totaladmin = mysqli_num_rows($hitungadmin);

    //HITUNG PEMBINA
    $hitungpembina = mysqli_query($conn, "SELECT * FROM tb_pembina
    ...
    $totalpembina = mysqli_num_rows($hitungpembina);
...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            ...
            <strong>PEMBINA-<?php echo $data['id_ekskul'] . "-" . $data['ekstrakurikuler'] ?></strong>
        </h1>
        <ol class="breadcrumb">
